...
class MockRequests:
    ...
    def get(self, url: str, params: Dict[str, Any] = None, headers: Dict[str, str] = None, 
            cookies: Dict[str, str] = None, timeout: int = 30, **kwargs) -> MockResponse:
        """发送GET请求
    ...
    def post(self, url: str, data: Any = None, json: Dict[str, Any] = None, 
             headers: Dict[str, str] = None, cookies: Dict[str, str] = None, 
             timeout: int = 30, **kwargs) -> MockResponse:
        """发送POST请求
    ...
    def put(self, url: str, data: Any = None, json: Dict[str, Any] = None, 
            headers: Dict[str, str] = None, cookies: Dict[str, str] = None, 
            timeout: int = 30, **kwargs) -> MockResponse:
        """发送PUT请求
...
class MockSession:
    ...
    def post(self, url: str, data: Any = None, json: Dict[str, Any] = None, 
             headers: Dict[str, str] = None, timeout: int = 30, **kwargs) -> MockResponse:
        """发送POST请求
...
def create_mock_response(status_code: int = 200, text: str = '', content: bytes = b'') -> MockResponse:
    """创建Mock响应
