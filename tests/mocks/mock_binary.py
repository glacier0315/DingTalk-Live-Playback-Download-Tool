...
class MockFFmpegWrapper:
    ...
    def merge(self, input_files: List[str], output_file: str, options: Dict[str, Any] = None) -> bool:
        """合并视频文件
    ...
    def crop(self, input_file: str, output_file: str, x: int, y: int, width: int, height: int) -> bool:
        """裁剪视频
    ...
    def add_watermark(self, input_file: str, watermark_file: str, output_file: str, options: Dict[str, Any] = None) -> bool:
        """添加水印
...
class MockN_m3u8DL_RE:
    ...
    def download_with_headers(self, url: str, output_file: str, headers: Dict[str, str], options: Dict[str, Any] = None) -> bool:
        """使用HTTP头下载M3U8视频
    ...
    def download_with_proxy(self, url: str, output_file: str, proxy: str, options: Dict[str, Any] = None) -> bool:
        """使用代理下载M3U8视频
    ...
    def download_with_key(self, url: str, output_file: str, key: str, iv: str, options: Dict[str, Any] = None) -> bool:
        """使用解密密钥下载M3U8视频
