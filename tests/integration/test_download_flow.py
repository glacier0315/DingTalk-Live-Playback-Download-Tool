...
def test_single_download_flow(mock_n_m3u8dl_re, mock_m3u8_parser, mock_cookie_handler):
    ...
    mock_m3u8_parser.return_value.fetch_m3u8_links.return_value = [
...
def test_batch_download_flow(mock_file_reader, mock_n_m3u8dl_re, mock_m3u8_parser, mock_cookie_handler):
    """测试批量下载流程"""
