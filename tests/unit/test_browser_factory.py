...
def test_browser_factory_multiple_creations():
    """测试创建多个浏览器实例"""
    with patch('dingtalk_downloader.browser.edge_driver.webdriver') as mock_edge_webdriver, \
         patch('dingtalk_downloader.browser.chrome_driver.webdriver') as mock_chrome_webdriver, \
         patch('dingtalk_downloader.browser.firefox_driver.webdriver') as mock_firefox_webdriver:
